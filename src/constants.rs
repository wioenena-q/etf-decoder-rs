...
pub const DEPRECATED_REFERENCE_EXT: u8 = 101;
pub const NEW_REFERENCE_EXT: u8 = 114;
pub const NEWER_REFERENCE_EXT: u8 = 99;
pub const REMOVED_FUN_EXT: u8 = 117;
pub const NEW_FUN_EXT: u8 = 112;
pub const EXPORT_EXT: u8 = 113;
pub const BIT_BINARY_EXT: u8 = 77;
pub const NEW_FLOAT_EXT: u8 = 70;
pub const ATOM_UTF_8_EXT: u8 = 118;
pub const SMALL_ATOM_UTF_8_EXT: u8 = 119;
pub const DEPRECATED_ATOM_EXT: u8 = 100;
pub const DEPRECATED_SMALL_ATOM_EXT: u8 = 115;